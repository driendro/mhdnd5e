...
def db_create(path):
    ...
    cursorObj.execute(
        """
        CREATE TABLE "main"."loot_criatura" (
            id integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
            nombre varchar(50) NOT NULL,
            carves integer NOT NULL,
    ...
    cursorObj.execute(
        """
        CREATE TABLE "main"."loot_item" (
            id integer NOT NULL PRIMARY KEY AUTOINCREMENT,
            nombre varchar(50) NOT NULL,
            descripcion text NOT NULL,
            arma bool NOT NULL,
            armadura bool NOT NULL,
            otro bool NOT NULL
            )
        """
    )
    ...
    cursorObj.execute(
        """
        CREATE TABLE "main"."loot_loot" (
            id integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
            val_min integer NOT NULL,
            val_max integer NOT NULL,
            criatura_id integer NOT NULL REFERENCES "loot_criatura" ("id") DEFERRABLE INITIALLY DEFERRED,
            item_id integer NOT NULL REFERENCES "loot_item" ("id") DEFERRABLE INITIALLY DEFERRED
            )
        """
        )
    print('Tabla loot ---> OK')
